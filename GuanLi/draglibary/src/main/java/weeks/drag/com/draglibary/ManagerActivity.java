package weeks.drag.com.draglibary;
...
import weeks.drag.com.draglibary.adapter.DragAdapter;
import weeks.drag.com.draglibary.adapter.OtherAdapter;
import weeks.drag.com.draglibary.app.AppApplication;
import weeks.drag.com.draglibary.bean.ChannelItem;
import weeks.drag.com.draglibary.bean.ChannelManage;
import weeks.drag.com.draglibary.view.DragGrid;
import weeks.drag.com.draglibary.view.OtherGridView;
 ...
 */
public class ManagerActivity extends Activity implements OnItemClickListener {
    /** 用户栏目的GRIDVIEW */
                ...
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        try {
                            ...
                            //  ImageUtils.MoveAnim(moveImageView, startLocation , endLocation, channel,otherGridView);
